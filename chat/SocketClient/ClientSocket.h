...
// Linux specific includes used in non-blocking keyboard input functions (Windows uses conio.h instead)
...
class ClientSocket
{
	...
	public:
		...
		// Linux specific functions for non-blocking keyboard input
		// Note: On windows you should just use the built in kbhit and getch functions
		// and completely ignore the resetTerminalMode and setConioTerminalMode functions!
